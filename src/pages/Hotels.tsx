...
const mockHotels: HotelProps[] = [
  {
    ...
    description: "Experience luxury in the heart of Manhattan with stunning views of Central Park and easy access to iconic landmarks.",
    price: 299,
    currency: "$",
    rating: 4.8,
  ...
  },
  {
    ...
    location: "Chicago, IL",
    description: "Affordable comfort in downtown Chicago with easy access to business districts and tourist attractions.",
    price: 149,
    currency: "$",
    rating: 4.2,
  ...
  },
  {
    ...
    location: "Boston, MA",
    description: "Charming hotel housed in a beautifully restored 19th-century building in Boston's historic district.",
    price: 229,
    currency: "$",
    rating: 4.5,
  ...
  },
  {
    ...
    location: "Phoenix, AZ",
    description: "Modern desert retreat featuring multiple pools, golf courses, and spectacular sunset views.",
    price: 279,
    currency: "$",
    rating: 4.4,
    image: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1080&q=80",
    amenities: ["Multiple Pools", "Golf Course", "Spa", "Restaurant", "Bar", "Fitness Center"]
  },
];
